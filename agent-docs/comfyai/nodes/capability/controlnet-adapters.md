...
- git-only ([install guide](../../knowledge/hiddenswitch/install-custom-nodes.md)) — [ComfyUI_InstantID](https://github.com/cubiq/ComfyUI_InstantID) *(6 nodes)*: ApplyInstantID, ApplyInstantIDAdvanced, ApplyInstantIDControlNet, InstantIDAttentionPatch, InstantIDFaceAnalysis, InstantIDModelLoader
