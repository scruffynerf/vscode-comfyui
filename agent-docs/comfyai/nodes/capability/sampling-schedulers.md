...
- git-only ([install guide](../../knowledge/hiddenswitch/install-custom-nodes.md)) — [LanPaint](https://github.com/scraed/LanPaint) *(4 nodes)*: LanPaint_KSampler, LanPaint_KSamplerAdvanced, LanPaint_SamplerCustom, LanPaint_SamplerCustomAdvanced
...
- git-only ([install guide](../../knowledge/hiddenswitch/install-custom-nodes.md)) — [ComfyUI-MMAudio](https://github.com/kijai/ComfyUI-MMAudio): MMAudioSampler
